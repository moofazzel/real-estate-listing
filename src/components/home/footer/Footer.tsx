...
function Footer() {
  return (
    <>
      <footer className="relative z-10 bg-gray-800 pt-16 pb-10">
        <div className="container px-6 text-white">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-[30%]">
              <div className="mb-6 w-full">
                ...
                <p className="text-dark flex items-center text-sm font-medium">
                  ...
                  <span>+880 1938 688488</span>
                </p>
              </div>
            </div>
            <div className="w-full px-4 sm:w-1/2 lg:w-1/5">
              <div className="mb-10 w-full">
                <h4 className="text-dark mb-7 text-xl font-bold">
                  Quick Links
                </h4>
                <ul>
                  <li>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-[23%]">
              <div className="mb-10 w-full">
                <h4 className="text-dark mb-7 text-xl font-bold">Contact Us</h4>
                <ul>
                  <li>
                    <a
                      href="javascript:void(0)"
                  ...
                  <li>
                    <a
                      ...
                      className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose"
                    >
                      Najirghat main road, Khulna <br /> Bangladesh
                    </a>
                  </li>
                  <li>
                    <a
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-[27%]">
              <div className="mb-10 w-full">
                <h4 className="text-dark mb-7 text-xl font-bold">
                  Follow Us On
                </h4>
                ...
                <h4 className="text-dark mb-4 text-xl font-bold">Subscribe</h4>
                <div
                  data-element="fields"
                  data-stacked="false"
                ...
                >
                  <div className="relative w-full mr-3 formkit-field">
                    ...
                    <input
                      id="member_email"
                      className="formkit-input bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5"
                      name="email_address"
                  ...
                  <button data-element="submit" className="formkit-submit">
                    ...
                    <span className="flex items-center px-5 py-3 text-sm font-medium text-center text-gray-900 bg-white rounded-full cursor-pointer hover:bg-main focus:ring-4 focus:ring-blue-300 transition-all duration-300 group">
                      <BiRightArrow className="fill-black group-hover:fill-white" />
                    </span>
                  </button>
                </div>
              </div>
